...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "e", function()
		awful.spawn.with_shell(app.explorer)
	end, { description = "open file explorer", group = "launcher" }),
	awful.key({ modkey }, "r", function()
		awful.spawn.with_shell(app.reminder)
	end, { description = "open reminder", group = "launcher" }),

	awful.key({ modkey }, "y", function()
		awful.spawn.with_shell("sh ~/Scripts/YTDownloader.sh")
	end, { description = "download yt video", group = "launcher" }),
	...
	end, { description = "run window_picker", group = "launcher" }),

	awful.key({ modkey }, "s", function()
		require("configuration.ui.rofi.search_spotlight").setup()
	end, { description = "search selector", group = "launcher" }),
	...
	awful.key({ modkey }, ".", function()
		awful.spawn(app.emoji)
	end, { description = "run rofi emoji", group = "launcher" }),
	awful.key({ modkey }, "t", function()
		awful.spawn.with_shell(app.create_notion_task)
	end, { description = "create task in notion", group = "launcher" }),
	awful.key({ modkey, "Control" }, "Delete", function()
		awful.spawn.with_shell("systemctl poweroff")
	end, { description = "shutdown system", group = "launcher" }),
...
client.connect_signal("request::default_keybindings", function()
	awful.keyboard.append_client_keybindings({
		...
		end, { description = "toggle sticky prop", group = "client" }),
