...
-- imports helper functions for internal use
-- imports.helpers
local helpers = {}

helpers.imports_dir = debug.getinfo(1, 'S').source:match [[^@(.*/).*$]]
helpers.icons_dir   = helpers.imports_dir .. 'icons/'
helpers.scripts_dir = helpers.imports_dir .. 'scripts/'
